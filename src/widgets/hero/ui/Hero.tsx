...
const Hero = () => {
	...
	return (
		<section className="w-full px-6 pt-20 pb-16 flex flex-col items-center text-center">
			...
			<h1 className="mb-4 bg-linear-to-r from-[#0a66c2] via-[#0f9f6f] to-[#8443ce] bg-clip-text text-5xl font-semibold tracking-tight text-transparent md:text-6xl">
				Welcome to Soulmate
			</h1>
			...
			<Button
				className="bg-primary text-white px-6 py-3 hover:bg-primary-hover"
