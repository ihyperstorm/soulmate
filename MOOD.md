...
| 6 | Conversation starters по настроению | ⬜ не начато |
| 7 | i18n | ✅ сделано |

**Где сейчас стоит фича.** Код готов целиком, кроме фазы 6. Настроение задаётся
с дашборда, участвует в сортировке всех списков людей и видно в карточке.
